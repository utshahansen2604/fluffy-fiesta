...
while ! curl --silent http://jenkinsmaster:8800 | grep 'You are authenticated'; do echo .; sleep 1; done
while ! wget --quiet http://jenkinsmaster:8800/jnlpJars/agent.jar -O /dev/null; do
